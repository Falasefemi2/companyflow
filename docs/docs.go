...
const docTemplate = `{
    ...
    "paths": {
        "/approval-history": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Entity type (leave_request/memo)",
                        "name": "entityType",
                        "in": "query",
                        "required": true
                    },
        ...
        "/approval-workflows": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Workflow type (leave/memo/expense)",
                        "name": "workflowType",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "boolean",
                        "description": "Only active workflows (default true)",
                        "name": "onlyActive",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create approval workflow payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/companies/{company_id}/employees/bulk": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/services.BulkCreateEmployeesResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/companies/{company_id}/leave-types": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Leave type status (active/inactive)",
                        "name": "status",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create leave type payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateLeaveTypeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/leave-requests": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Request leave payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RequestLeaveRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RejectLeaveRequestRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/leave-types/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update leave type payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateLeaveTypeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/memos": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create memo payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateMemoRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/dto.MemoActionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "dto.BulkEmployeeError": {
            "type": "object",
            "properties": {
                "errors": {
                    "description": "Multiple validation errors per row",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "record": {
                    "$ref": "#/definitions/dto.BulkEmployeeRecord"
                },
                "rowNumber": {
                    "type": "integer"
                }
        ...
        "dto.BulkEmployeeRecord": {
            ...
            "properties": {
                ...
                "password": {
                    "description": "temporary, only for CSV parsing",
                    "type": "string"
                },
                "phone": {
                    "type": "string"
        ...
        "dto.RequestLeaveRequest": {
            ...
            "properties": {
                ...
                "startDate": {
                    "description": "\"2025-02-10\" (YYYY-MM-DD format)",
                    "type": "string"
                }
            }
        },
        ...
        "services.BulkCreateEmployeesResponse": {
            "type": "object",
            "properties": {
                "createdEmployees": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.BulkCreatedEmployee"
                    }
                },
                "failureCount": {
                    "type": "integer"
                ...
                "validationErrors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.BulkEmployeeError"
                    }
                }
            }
        },
        "services.BulkCreatedEmployee": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
                ...
                "tempPassword": {
                    "description": "Must be shared with user securely",
                    "type": "string"
                }
            }
        },
